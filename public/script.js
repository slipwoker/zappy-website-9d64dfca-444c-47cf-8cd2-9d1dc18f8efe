  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        if (input.hasAttribute('required') || input.classList.contains('required')) {
          ...
          if (!value) {
            ...
            if (input.type === 'email' && !validateEmail(value)) {
              ...
              showError(input, input.getAttribute('data-error-phone') || 'Please enter a valid phone number');
              isValid = false;
      ...
      if (isValid) {
        ...
        if (submitBtn) {
          ...
          setTimeout(function() {
            submitBtn.textContent = submitBtn.getAttribute('data-success-text') || 'Sent!';
    ...
    contactForm.addEventListener('input', function(e) {
      ...
      if (input.classList.contains(errorClass)) {
        const value = input.value.trim();
        if (value) {
          if (input.type === 'email' && !validateEmail(value)) return;
          if (input.type === 'tel' && !validatePhone(value)) return;
          showSuccess(input);
        }
      }
    });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9d64dfca-444c-47cf-8cd2-9d1dc18f8efe',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9d64dfca-444c-47cf-8cd2-9d1dc18f8efe';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9d64dfca-444c-47cf-8cd2-9d1dc18f8efe';
